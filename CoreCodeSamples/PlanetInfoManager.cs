...
public class PlanetInfoManager : MonoBehaviour
{
    ...
    // Method to update UI elements with the planet's information
    public void SetPlanetInfo()
    {
        // Set text values based on the data from the planet object
        ...
        // Set the description of the planet's figure
